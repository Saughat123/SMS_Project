...
public class Deletedetails extends JInternalFrame implements ActionListener {
    ...
    private JLabel lblMotherName,  lblDOB,  lblAge,  lblCaste,  lblReligion,  lblbranch;
    private JLabel lblCity,  lblDistrict,  lblState,  lblPin,  lblYear,  lblQualification,lblcourse;
    private JTextField txtName,  txtAdNo,  txtPhNo,  txtFatherName,  txtOccupation,txtcourse;
    private JTextField txtMotherName,  txtDOB,  txtAge,  txtCaste,  txtReligion,  txtbranch;
    ...
    public Deletedetails() {
        ...
        lblcourse.setBounds(500,50,80,25);
		txtcourse.setBounds(600,50,130,25);
        lblbranch.setBounds(500, 90, 150, 25);
        txtbranch.setBounds(600, 90, 200, 25);
