...
public class MarkT extends JInternalFrame implements ActionListener {
	...
	JButton jb7 = new JButton("Semester7");
	JButton jb8 = new JButton("Semester8");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == jb5) {
            ...
            ps.setVisible(true);
		        ...
		        if (e.getSource() == jb6) {
            PLUSTWO ps = new PLUSTWO(regno,"Sixth Semester marks",6);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }
		        if (e.getSource() == jb7) {
            PLUSTWO ps = new PLUSTWO(regno,"Seventh Semester marks",7);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }
		        if (e.getSource() == jb8) {
            PLUSTWO ps = new PLUSTWO(regno,"Eighth Semester marks",8);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }
        if (e.getSource() == jbc) {
